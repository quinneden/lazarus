{
  ...
  programs.firefox = {
    enable = true;
    package = inputs.nixpkgs-old.legacyPackages."aarch64-linux".firefox.override {
    ...
    home = {
      ...
      search = {
        ...
        engines = {
          ...
          srx = {
            urls = [{template = "https://searxng.site/search?q={searchTerms}";}];
            definedAliases = ["srx"];
          };
          ddg = {
          ...
          nhm = {
            urls = [
              {
                template = "https://github.com/nix-community/home-manager/search?q={searchTerms}";
              }
            ];
            definedAliases = ["nhm"];
          };
          iv = {
            urls = [{template = "https://iv.nboeck.de/search?q={searchTerms}";}];
            definedAliases = ["iv"];
          };
          lr = {
            urls = [{template = "https://reddit.simo.sh/search?q={searchTerms}";}];
            definedAliases = ["lr"];
          };
          wiki = {
            urls = [
          ...
          npm = {
            urls = [{template = "https://www.npmjs.org/search?q={searchTerms}";}];
            definedAliases = ["npm"];
          };
          osm = {
            urls = [
